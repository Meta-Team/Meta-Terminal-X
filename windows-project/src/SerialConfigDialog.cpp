...
static const char blankString[] = QT_TRANSLATE_NOOP("SerialConfigDialog", "N/A");

SerialConfigDialog::SerialConfigDialog(QWidget *parent) :
    QDialog(parent),
    m_ui(new Ui::SerialConfigDialogUI),
    m_intValidator(new QIntValidator(0, 4000000, this))
{
    ...
    connect(m_ui->applyButton, &QPushButton::clicked,
            this, &SerialConfigDialog::apply);
    connect(m_ui->serialPortInfoListBox, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &SerialConfigDialog::showPortInfo);
    connect(m_ui->baudRateBox,  QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &SerialConfigDialog::checkCustomBaudRatePolicy);
    connect(m_ui->serialPortInfoListBox, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &SerialConfigDialog::checkCustomDevicePathPolicy);
    connect(m_ui->refreshButton, &QPushButton::clicked,
            this, &SerialConfigDialog::fillPortsInfo);
    fillPortsParameters();
    fillPortsInfo();
    updateSettings();
}
...
SerialConfigDialog::Settings SerialConfigDialog::settings() const
{
    return m_currentSettings;
}

void SerialConfigDialog::showPortInfo(int idx)
{
    if (idx == -1)
        return;
...
void SerialConfigDialog::checkCustomBaudRatePolicy(int idx)
{
...
void SerialConfigDialog::checkCustomDevicePathPolicy(int idx)
{
...
void SerialConfigDialog::fillPortsParameters()
{
...
void SerialConfigDialog::fillPortsInfo()
{
